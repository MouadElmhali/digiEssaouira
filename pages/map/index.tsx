                ...
                <div className="flex flex-col sm:flex-row justify-between p-10 mt-28 sm:mt-36 container mx-auto md:px-20">
                    <div className="sm:w-1/2">
                        ...
                        <p className="mt-14 text-xl text-justify">تشكل الجماعة أحد مستويات التنظيم الترابي للمملكة، وهي جماعة ترابية خاضعة للقانون العام، تتمتع بالشخصية الاعتبارية والاستقلال الإداري والمالي.
                            ...
                            <br />
                            <br />
                            يضم إقليم الصويرة 57 جماعة محلية، موزعين على أربع (04) دوائر (دائرة الصويرة، دائرة أيت داود، دائرة الحنشان، دائرة تمنار) وخمس (05) باشويات (باشوية الصويرة، باشوية أيت داود، باشوية تمنار، باشوية الحنشان وباشوية تالمست).
                        </p>
                    </div>
                    <div className="sm:w-1/2 flex items-center justify-center">
                        ...
                        >
                            ...
                            <path
                                data-region="4"
                                className="st0 transition ease-in-out duration-200 cursor-pointer"
                            ...
                            />
                            <path
                                className="st0 transition ease-in-out duration-200 cursor-pointer" data-region="1"
