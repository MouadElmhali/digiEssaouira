...
import { GET_YOUTHARTICLE_BY_ID } from '../../graphql/youthArticle/queries';
...
interface IContext {
  ...
  export async function getServerSideProps({
    ...
    const { data: youthArticle } = await client.query({
      query: GET_YOUTHARTICLE_BY_ID,
      variables: { id: id },
    });
  
    return { props: { youthArticle, id } };
  }

export default function Young ({
    youthArticle
  }: InferGetServerSidePropsType<typeof getServerSideProps>): JSX.Element {
    const {title, body, pictureUrl} = youthArticle.youthArticle
        ...
        <>
            ...
            <main>
                <div className='mt-48 mb-48 flex flex-col items-center justify-center gap-12 mx-12 lg:mx-48'>
                    ...
                    <img src={"/images/youthArticles/" + pictureUrl} alt="object-cover w-full" />
