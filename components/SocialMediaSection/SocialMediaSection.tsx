export const SocialMediaSection = ({className}) => {
    return (
        <div className="md:text-right text-center">
          <div className="flex gap-3 items-center justify-center md:items-start md:justify-start">
            <a href="#" title="Share on Facebook" className="hover:scale-125 transition ease-in-out duration-200">
              <svg
                className={className ?? "fill-white text-white"}
            ...
            <a href="#" title="Share on WhatsApp" className="hover:scale-125 transition ease-in-out duration-200">
              <svg
                className={className ?? "fill-white text-white"}
                xmlns="http://www.w3.org/2000/svg"
                x="0px"
            ...
            <a href="#" title="Share on Twitter" className="hover:scale-125 transition ease-in-out duration-200">
              <svg
                className={className ?? "fill-white text-white"}
                xmlns="http://www.w3.org/2000/svg"
                x="0px"
            ...
            <a href="#" className="hover:scale-125 transition ease-in-out duration-200">
              <svg
                className={className ?? "fill-white text-white"}
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 250 250"
