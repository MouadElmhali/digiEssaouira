...
export default function Header({
  ...
  return isHero ?
    styles ?
      (
        <header
          className={` w-full  md:h-[80vh] sm:h-[65vh] bg-center bg-cover bg-no-repeat bg-center relative z-0 sm:right-1/2 sm:translate-x-1/2  sm:mt-40 after:content-[''] after:absolute  after:h-full after:w-full after:left-0 after:top-0 after:-z-[1] ${styles}  `}
        >
