        ...
        <div className="flex items-center justify-center">
            ...
            >
                ...
                <g id="Essaouira_region_1_">
                    ...
                    <path data-region="0" className="st0" d="M222,59.4l0.3-13.8c0,0-7.1,0.5-11.2,6.1c-4.1,5.6-20.3,4.8-20.3,4.8l-20.6,15.1l-6.6,14.7   c0,0,4.9,5.1,4.3,7.5c-0.5,2.4-4.2,6.6-4.2,6.6l-10.5,5.6c0,0-6.3,2.7-4.7,10.7c1.5,8,5.4,25,5.4,25s12.8-4.7,15.6-8.6   c0,0,12.5-0.5,14.8,2c0,0,27.8-32.7,29.8-35.4c0,0-10.5-9.7-10.3-17.9c0.3-8.2,8.8-17.7,10.5-18.4C216,63,222,59.4,222,59.4z" />
                    <path data-region="0" className="st0" d="M62.7,222.6L61,253.5l12.8,1.5c0,0,0.5,0.8,0.5,4.1c0,3.3-1.8,9.2-2,10c-0.3,0.8-10.7,2.6-12.8,2.8   s-1.3,8.7-1.3,8.7s1.3,1.8-0.3,4.1c-1.5,2.3-1.5,6.1-1.5,6.1l-0.3,21.4c0,0,4.9-1.5,7.9,1.8c3.1,3.3,6.6,3.3,6.4,7.4l-11.7,12.3   c0,0-4.3,2-16.3-3.6c0,0-15.1-2.6-20.7,14.8L11.2,350c0,0-2.1-3.6-6.3-3.1c0,0-13.1-18.7,5.8-34.4c0,0,24.3-25.3,20.1-51.7   C30.8,260.8,52.3,239,62.7,222.6z" />
                    <path className="st0" d="M214.1,99.9c0,0-10.4-9.1-10.3-17.9c0.1-8.8,8.3-16.9,10.5-18.4c0,0,2.5,4,3.6,4.2s3.6,3.2,3.6,4.7   c0,1.5,0.3,16.6,0.3,16.6L214.1,99.9z" />
                </g>
            </svg>
        </div>
        {show &&
