    ...
    const mapData: Array<any> = [
        {
            ...
            president: " الرئيس محمد صبحي حزب الإستقلال",
...

        {
            ...
            president: "الرئيس محمد عبد الصادق السعيدي حزب الإتحاد الإشتراكي للقوات الشعبية",
        ...
        {
            city: "جماعة تكاط  ",
            president: "الرئيس كمال القلولي حزب الأصالة والمعاصرة",
        ...
        {
            city: "جماعة حد الدرى",
            president: "الرئيس يوسف الصديقي حزب الإستقلال",
            image: "/images/electeds/heddraa.jpg",
        },

        {
            city: "جماعة مولاي بوزرقطون",
            president: "الرئيس ريضا فيض حزب التجمع الوطني للأحرار",
